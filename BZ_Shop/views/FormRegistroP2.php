        ...
        <div class="card-body py-5 px-md-5">
          ...
          <h3 align="center">Paso 2</h3>
            ...
            <div class="form-outline mb-4">
              ...
              <input type="email" name="correo"  class="form-control" placeholder="Escribe tu nombre"/>
            </div>
            ...
            <div class="form-outline mb-4">
              ...
              <input type="text" name="Contraseña"" class="form-control" placeholder="Escribe tu contraseña"/>
            </div>
             <!-- Numero de telefono -->
