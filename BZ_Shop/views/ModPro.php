  ...
  <body>
            ...
            <input type="hidden" name="id" value="<?=$_GET["id"]?>">
                ...
                <?php
                    ...
                    include "../views/modicarIF.php";
                    foreach($miconsulta as $datos)
                    {?>

<!--Ciclo para mostrar el formulario-->
                       
                        <div class="mb-3">
                                    <label for="nombre" class="form-label"><strong>Nombre</strong></label>
                                    <input type="text" name="nombre" id="" class="form-control" value="<?= $datos->nombre?>">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <input type="text" name="existencia" id="" class="form-control" value="<?= $datos->exitencia?>">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <select class='nav-item dropdown  form-select  quitar-borde'>
                                <option selected>$datos->nom_cat</option>";
                                foreach($reg as $value)
                                {
                                    echo "<option class='dropdown-item' name='categoria'    value='".$value->cve_cat."'>".$value->nom_cat."</option> ";
                                }
                                ...
                                foreach($reg as $value)
                                {
                                    echo "<option class='dropdown-item' name='categoria_prenda' value='".$value->cve_pcat."'>".$value->prenda."</option> ";
                                }
                                echo "</select>";
                                ?>
                                <br>
                                ...
                                foreach($reg as $value)
                                {
                                    echo "<option class='dropdown-item' name='genero' value='".$value->cve_gen."'>".$value->genero."</option> ";
                                }
                                echo "</select>";
                                ?>
                                <br>
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="imagen" id="" value="<?= $datos->link ?>" class="form-control" placeholder="Escribe la imagen del producto aqui">
                                </div>
